/**
 * Browser side of the shareable view state. The encoding itself lives in
 * lib/view-state so the MCP server can read the same links.
 */

import { parseViewHash, serializeViewHash, type ViewState } from "@/lib/view-state";

export { DEFAULT_PARAMS, DEFAULT_VIEW } from "@/lib/view-state";
...
/** The full shareable link for the current view. */
