/**
 * Stage 5: join geometry and demographics into the committed tract file,
 * and write a manifest describing what was built.
 */

import { mkdirSync, writeFileSync } from "node:fs";
import path from "node:path";
import type { TractProps } from "../lib/analysis/types";
